...
import com.example.myscienceapp.databinding.FragmentFirstBlankBinding
...
class FirstBlankFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nextButton.setOnClickListener {
            navController.navigate(R.id.action_firstBlankFragment_to_secondBlankFragment) //Navigate from 1st page to 2nd page on button click
        }
    }
