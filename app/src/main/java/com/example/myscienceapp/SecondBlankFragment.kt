...
import com.example.myscienceapp.databinding.FragmentSecondBlankBinding
...
class SecondBlankFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nextButton2.setOnClickListener {
            navController.navigate(R.id.action_secondBlankFragment_to_thirdBlankFragment) //Navigate from 2nd page to 3rd page on button click
        }
        binding.backButton1.setOnClickListener {
            navController.navigate(R.id.action_secondBlankFragment_to_firstBlankFragment) //Navigate from 2nd page back to 1st page on button click
        }
    }
